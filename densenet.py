'''
Inspired by the implementation of https://github.com/tdeboissiere/DeepLearningImplementations/tree/master/DenseNet
There are some minor modifications on the code to fitting the project 
'''
